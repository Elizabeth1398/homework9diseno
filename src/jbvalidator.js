    ...
    $.fn.jbvalidator = function (options) {
        ...
        let errorMessages = {
            ...
            HTML5: {
                valueMissing: {
                    INPUT: {
                        default: "Por favor rellenar este campo.",
                        checkbox: "Por favor seleccione una de las opciones.",
                        radio: "Por favor seleccione una de las opciones.",
                        file: "Please select a file."
                    },
                    SELECT: "Por favor seleccione una opcion"
                },
                typeMismatch: {
                    email: "Por favor ingrese una direccion de correo electronica.",
